...
{
    public class SphyrnidaeVariableWebService : WebServiceBase, IVariableWebService
    {
        ...
        public SphyrnidaeVariableWebService(
            ...
            : base(factory, settings, identity, encryption, new NonLogger())
        {
            Env = env;
            App = app;
        }
