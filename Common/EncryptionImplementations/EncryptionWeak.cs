...
namespace Sphyrnidae.Common.EncryptionImplementations
{
    ...
    /// </summary>
    public class EncryptionWeak : EncryptionImplementation
    {
        protected IEncryptionKeyManager KeyManager { get; }
        public EncryptionWeak(IEncryptionKeyManager keyManager)
        {
        ...
        public override string Id => "3afcd81b-44a1-4d9c-8066-559b411d543f";
        #endregion
