...
namespace Sphyrnidae.Common.EncryptionImplementations
{
    ...
    /// </summary>
    public class EncryptionStrong : EncryptionImplementation
    {
        protected IEncryptionKeyManager KeyManager { get; }
        public EncryptionStrong(IEncryptionKeyManager keyManager)
        {
        ...
        public override string Id => "ca6b07c9-c1ca-461b-bbde-9797694f985d";
        #endregion
