...
namespace Sphyrnidae.Common.EncryptionImplementations
{
    ...
    /// </summary>
    public class EncryptionNormal : EncryptionImplementation
    {
        protected IEncryptionKeyManager KeyManager { get; }
        public EncryptionNormal(IEncryptionKeyManager keyManager)
        {
        ...
        protected const int Iterations = 1000;
        protected const int MinPasswordLength = 12;

        public override string Id => "567b0851-db66-46f1-8db6-13674ef9a501";
        #endregion
