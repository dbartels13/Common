...
{
    public abstract class CustomInformation2 : CustomInformation
    {
        /// <summary>
        ...
        protected CustomInformation2(ILoggerInformation info, IApplicationSettings appSettings) : base(info, appSettings) { }
