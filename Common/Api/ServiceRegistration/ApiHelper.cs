    ...
    public static class ApiHelper
    {
        public static void ControllerConfiguration(ApiBehaviorOptions options) =>
            options.InvalidModelStateResponseFactory = context =>
            {
                ...
                return new OkObjectResult(ApiResponse.ModelStateErrors(errors));
            };
        ...
        public static List<Pipeline> DefaultPipeline =>
            new List<Pipeline>
            {
        ...
        public static void AddMiddlewareToPipeline(IApplicationBuilder app, Pipeline item, IServiceProvider sp, ServiceConfiguration config)
        {
        ...
        /// <summary>
        /// Helper method to add a middleware item to the default pipeline
        /// </summary>
        ...
        /// <param name="beforeItem">The location in the default pipeline where the 'item' will get inserted before</param>
        /// <returns>The pipeline with the item added</returns>
        public static List<Pipeline> AddToPipeline(Pipeline item, Pipeline beforeItem)
            => DefaultPipeline.AddToPipeline(item, beforeItem);
